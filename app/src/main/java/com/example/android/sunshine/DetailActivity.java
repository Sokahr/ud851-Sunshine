...
//      DONE (8) Use mDetailBinding to display the date
        ...
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(SunshineWeatherUtils
                .getLargeArtResourceIdForWeatherCondition(weatherId));
//      done (15) Create the content description for the description for a11y
        String a11yDescription = getString(R.string.a11y_forecast, description);
...
//      DONE (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryInfo.weatherIcon.setContentDescription(a11yDescription);
        /**************************
