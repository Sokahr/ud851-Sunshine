...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager
        .LoaderCallbacks<String[]> {

    private static final String TAG = MainActivity.class.getSimpleName();
    private static final int WEATHER_LOADER_KEY = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_LOADER_KEY, null, MainActivity.this);
    }
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try {
                    ...
                    mCachedWeatherData = simpleJsonWeatherData;
                    return mCachedWeatherData;
