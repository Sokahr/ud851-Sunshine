...
public class MainActivity extends AppCompatActivity {
    ...
    // DONEO (25) Within onCreateViewHolder, inflate the list item xml into a view
    // DONE (26) Within onCreateViewHolder, return a new ForecastAdapterViewHolder with the above view passed in as a
    // parameter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (38) Create layoutManager, a LinearLayoutManager with VERTICAL orientation and shouldReverseLayout ==
        // false
        ...
        // DONE (40) Use setHasFixedSize(true) on mRecyclerView to designate that all items in the list will have the
        // same size
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            // DONE (46) Instead of setting the text to "", set the weatherData to null before refreshing
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                showWeatherDataView();
                // DOne (45) Instead of iterating through every string, use mForecastAdapter.setWeatherData and pass in
                // the weather data
