...
public class WeatherProvider extends ContentProvider {
    ...
    //  DONE (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(CONTENT_AUTHORITY, PATH_WEATHER, CODE_WEATHER);
        matcher.addURI(CONTENT_AUTHORITY, PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
        return matcher;
    }
...
//      DONE (9) Handle queries on both the weather and weather with date URI
        ...
        switch (match) {
            case CODE_WEATHER:
                resultCursor = db.query(WeatherEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
