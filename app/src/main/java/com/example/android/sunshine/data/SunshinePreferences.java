...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String metricsValue = context.getString(R.string.pref_units_metric);
        String prefUnit = sharedPreferences.getString(unitKey, metricsValue);

        return prefUnit.equals(metricsValue);
    }
